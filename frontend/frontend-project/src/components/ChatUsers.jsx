...
// import { useWebSocket } from '../contexts/WebSocketContext'; // adjust the path as needed
...
//       {chatUsers.length === 0 && !error && (
//         <div className="text-gray-500">No messages yet.</div>
//       )}

//       {chatUsers.map(({ user, lastMessage, lastMessageAt, unreadCount }) => (
//         <div
//           key={user.id}
...
//           <div className="text-right text-sm text-gray-500 ml-4 min-w-[70px]">
//             <div>
//               {lastMessageAt &&
...
//             </div>
//             {unreadCount > 0 && (
//               <div className="text-red-500 font-bold">{unreadCount}</div>
//             )}
//           </div>
//         </div>
//       ))}
