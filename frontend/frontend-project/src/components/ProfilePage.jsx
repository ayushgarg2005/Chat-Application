...
//       const res = await axios.put(`http://localhost:3000/user/${user.id}`, updatePayload, {
//         withCredentials: true,
//       });
...
//   if (!user) {
//     return <div className="text-center mt-20 text-gray-500 text-lg">Loading your profile...</div>;
//   }
...
//               {isEditing ? <Pencil size={22} /> : <UserCircle2 size={26} />}{" "}
...
//                 }));
//               }}
//               className="flex items-center gap-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-sm transition"
//             >
//               {isEditing ? (
//                 <>
//                   <X size={16} /> Cancel
...
//               }`}
//             >
//               {message.includes("✔️") ? <CheckCircle size={18} /> : <AlertTriangle size={18} />}
//               {message.replace("✔️", "").replace("❌", "").trim()}
//             </div>
//           )}
...
//               alt="Profile"
//               className="w-28 h-28 rounded-full object-cover border-4 border-gray-300 shadow-sm transition-transform duration-200 hover:scale-105"
//             />
//           </div>

//           {isEditing ? (
//             <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
//               <div className="md:col-span-2 text-gray-700 font-semibold border-b pb-1">
//                 Personal Info
//               </div>
...
//                 To change your password, your current password is required.
//               </div>

//               <div className="md:col-span-2">
//                 <button
//                   type="submit"
//                   className="w-full py-2 px-4 rounded-xl bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold transition-all shadow-md hover:shadow-lg"
//                 >
//                   Save Changes
//                 </button>
//               </div>
